...
!(function (t, e) {
	...
	['div', 'p', 'span'].forEach(function (i) {
			...
			return (
				...
				(t.onload = function () {
					(e.width = t.offsetWidth || t.width),
						...
						1 < i.length && 'function' == typeof i[1] ? ((e.fn = i[1]), e.fn()) : 1 < i.length && 'function' == typeof i[2] && ((e.fn = i[2]), e.fn());
				}),
				(e = c(t, this))
			);
		}),
		...
		(d.prototype.createSelect = function () {
			...
			return (
				'object' == typeof e && 'SELECT' === e.elt.nodeName
					...
					: ((o = document.createElement('select')), e && 'boolean' == typeof e && o.setAttribute('multiple', 'true'), (t = c(o, this))),
		...
		(d.prototype.createRadio = function (t) {
			...
			'object' == typeof t ? ((n = t), (r = this.elt = t.elt)) : ((r = document.createElement('div')), (n = c(r, this))),
				...
				t
					? t instanceof d.Color
						...
						: ((d.prototype._colorMode = 'rgb'),
						  (d.prototype._colorMaxes = {rgb: [255, 255, 255, 255], hsb: [360, 100, 100, 1], hsl: [360, 100, 100, 1]}),
		...
		(d.prototype.createCapture = function () {
			...
			return (
				...
				o.addEventListener('loadedmetadata', function () {
					o.play(),
						o.width ? ((s.width = o.videoWidth = o.width), (s.height = o.videoHeight = o.height)) : ((s.width = s.elt.width = o.videoWidth), (s.height = s.elt.height = o.videoHeight)),
						(s.loadedmetadata = !0);
				}),
				s
			);
		...
		(d.Element.prototype.child = function (t) {
			return void 0 === t
				? this.elt.childNodes
				: ('string' == typeof t ? ('#' === t[0] && (t = t.substring(1)), (t = document.getElementById(t))) : t instanceof d.Element && (t = t.elt), this.elt.appendChild(t), this);
		}),
		(d.Element.prototype.center = function (t) {
			...
			var o = Math.abs(this.parent().offsetWidth - this.elt.offsetWidth),
				...
				a = r.x;
			return (
				'both' === t || void 0 === t ? this.position(o / 2, s / 2) : 'horizontal' === t ? this.position(o / 2, l) : 'vertical' === t && this.position(a, s / 2),
		...
		(d.Element.prototype._translate = function () {
			...
			var t = '';
			return (
				this.elt.style.transform && (t = (t = this.elt.style.transform.replace(/translate3d\(.*\)/g, '')).replace(/translate[X-Z]?\(.*\)/g, '')),
				2 === arguments.length
		...
		(d.Element.prototype._rotate = function () {
			var t = '';
			return (
				this.elt.style.transform && (t = (t = this.elt.style.transform.replace(/rotate3d\(.*\)/g, '')).replace(/rotate[X-Z]?\(.*\)/g, '')),
				1 === arguments.length
			...
			if (i !== r || n !== r) {
				...
				(this.width = this.elt.offsetWidth),
					...
					this._pInst &&
						...
						(this._pInst._setProperty('width', this.elt.offsetWidth), this._pInst._setProperty('height', this.elt.offsetHeight));
			}
			return this;
		}),
		...
		(d.MediaElement.prototype.loadPixels = function () {
			if ((this.canvas || ((this.canvas = document.createElement('canvas')), (this.drawingContext = this.canvas.getContext('2d'))), this.loadedmetadata)) {
				this.canvas.width !== this.elt.width &&
					((this.canvas.width = this.elt.width), (this.canvas.height = this.elt.height), (this.width = this.canvas.width), (this.height = this.canvas.height), (this._pixelsDirty = !0));
				var t = this.elt.currentTime;
				(this._pixelsDirty || this._pixelsTime !== t) &&
					((this._pixelsTime = t), (this._pixelsDirty = !0), this.drawingContext.drawImage(this.elt, 0, 0, this.canvas.width, this.canvas.height), d.Renderer2D.prototype.loadPixels.call(this));
			}
